...
class DateFeaturesUseCaseImpl : DateFeaturesUseCase {
    override fun getDaysToNextDayOfWeek(day: DayOfWeek): Int {
    ...
    override fun getEpochMillisFromLocalDate(dateAndTime: LocalDateTime): Long {
