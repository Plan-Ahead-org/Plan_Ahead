package com.example.planahead.screens.home.ui
...
import com.example.planahead.screens.home.ui.components.AlertTypeSwitch
import com.example.planahead.screens.home.ui.components.OneTimeOptions
import com.example.planahead.screens.home.ui.components.TaskCard
...
fun HomeScreen(viewModel: HomeScreenViewModel, navHostController: NavHostController) {
    Scaffold {
        ...
        LaunchedEffect(lastExpanded.value){//TODO przebudować, zrobione na chwilę
            val id = tasks.value.indexOf(tasks.value.find {idToTask-> idToTask.id == lastExpanded.value })
            ...
            LazyRow(state = taskRowScrollState) {
                items(tasks.value){task->
                    TaskCard(
                        ...
                        onDelete = { taskToDelete -> viewModel.deleteTask(taskToDelete) }, onExpanded = {id->
